...
void nvme_pcie_qpair_manual_complete_tracker(struct spdk_nvme_qpair *qpair,
		...
		bool print_on_error);
void nvme_pcie_pg_cc_parse_pg_id(struct spdk_nvme_qpair *qpair, struct nvme_tracker *tr, uint32_t page_size, struct spdk_nvme_cpl *cpl);
...
void nvme_pcie_qpair_complete_tracker_hit_in_driver(struct spdk_nvme_qpair *qpair, struct nvme_tracker *tr, struct spdk_nvme_cpl *cpl, bool print_on_error);
void nvme_pcie_process_cache_completion(struct spdk_nvme_qpair *qpair, struct nvme_tracker *tr);
