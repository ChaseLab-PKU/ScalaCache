...
uint32_t spdk_nvme_ctrlr_get_shard_pg_num(const struct spdk_nvme_ctrlr *ctrlr);
uint32_t spdk_nvme_ctrlr_get_ftl_num(const struct spdk_nvme_ctrlr *ctrlr);
uint64_t spdk_nvme_ctrlr_get_cachesize_per_qpair(const struct spdk_nvme_ctrlr *ctrlr);
uint64_t spdk_nvme_ctrlr_trans_pgid2ftlid(const struct spdk_nvme_ctrlr *ctrlr, uint32_t pg);
uint64_t spdk_nvme_ctrlr_get_cachesize_per_qpair_per_ftl(const struct spdk_nvme_ctrlr *ctrlr);
...
int spdk_nvme_ctrlr_free_host_memory_buffer(struct spdk_nvme_ctrlr *ctrlr);
...
int spdk_nvme_ctrlr_cmd_set_host_memory_buffer(struct spdk_nvme_ctrlr *ctrlr, 
								spdk_nvme_cmd_cb cb_fn, void *cb_arg);
...
int spdk_nvme_ns_cmd_pg_cc_cp_data(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
...
int spdk_nvme_ns_cmd_pg_cc_writev_with_md(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				    uint64_t lba, uint32_t lba_count,
				    spdk_nvme_cmd_cb cb_fn, void *cb_arg, uint32_t io_flags,
				    spdk_nvme_req_reset_sgl_cb reset_sgl_fn,
				    spdk_nvme_req_next_sge_cb next_sge_fn, void *metadata,
...
int spdk_nvme_ns_cmd_pg_cc_write_with_md(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				   void *payload, void *metadata,
				   uint64_t lba, uint32_t lba_count, spdk_nvme_cmd_cb cb_fn,
				   void *cb_arg, uint32_t io_flags,
				   uint16_t apptag_mask, uint16_t apptag);
...
int spdk_nvme_ns_cmd_pg_cc_readv_with_md(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				   uint64_t lba, uint32_t lba_count,
				   spdk_nvme_cmd_cb cb_fn, void *cb_arg, uint32_t io_flags,
				   spdk_nvme_req_reset_sgl_cb reset_sgl_fn,
				   spdk_nvme_req_next_sge_cb next_sge_fn, void *metadata,
...
int spdk_nvme_ns_cmd_pg_cc_read_with_md(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				  void *payload, void *metadata,
				  uint64_t lba, uint32_t lba_count, spdk_nvme_cmd_cb cb_fn,
				  void *cb_arg, uint32_t io_flags,
				  uint16_t apptag_mask, uint16_t apptag);
