...
/**
 * Query whether block device has an enabled page cache
*/
bool spdk_bdev_has_page_cache(const struct spdk_bdev *bdev);
 ...
 *   * -ENOMEM - spdk_bdev_io buffer cannot be allocated
 */
int spdk_bdev_unpin(struct spdk_bdev_desc *desc, struct spdk_io_channel *ch,
