...
enum {
    ...
    NAND_READ_LATENCY = 30000,
    NAND_PROG_LATENCY = 80000,//50000,
    NAND_ERASE_LATENCY = 2000000,//2000000,
};
...
struct sub_ssd {
    ...
    struct line_mgmt lm;
    struct page_cache_mgr *page_cache_mgr;
    struct page_cache_mgr_ops page_cache_ops;

    struct ppa *backup_maptbl;
    int64_t *avaliable_time;
    struct HMBEntryDesptr *page_cache_desptr;
    int id;
    uint32_t page_cache_desptr_sz;
    uint64_t page_cache_size;
    struct ssd *parent_ssd;
    AddressSpace *as;
    SsdDramBackend  *mbe;
};
